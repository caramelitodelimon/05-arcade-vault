...
// ===== app/home/page.tsx =====
// Portado de references/templates/home-about/home.jsx (Home). Landing
// canónica del sitio (spec 02-home-landing); "/" redirige acá. Los datos de
// "actividad en vivo" y "stats" quedan hardcodeados inline, igual que en el
// prototipo — no leen de seededScores() ni de ningún backend.

import Link from "next/link";
import { GAMES } from "@/lib/data";
import { useReveal } from "@/lib/use-reveal";
import { HomeSilhouettes } from "@/components/home-silhouettes";
import { HomeFeatureIcon, type FeatureIconKind } from "@/components/home-feature-icon";
...
const TICKER: { p: string; g: string; s: number; t: string; c: "cyan" | "magenta" | "yellow" | "green" }[] = [
