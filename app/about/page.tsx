...
// ===== app/about/page.tsx =====
// Portado de references/templates/home-about/about.jsx (About + Contact).
// El copy de la página (kicker, título, textos) sigue el template al pie de
// la letra; el link "Sobre nosotros" que apunta acá vive en components/nav.tsx
// con una etiqueta distinta — decisión explícita del usuario (spec
// 03-about-contacto-resend). El envío del formulario ya no es instantáneo
// como en el prototipo: llama a /api/contact (Resend) y agrega estados de
// carga y error que el prototipo no tenía.
...
export default function AboutPage() {
  ...
  const sendingOrIdle = status === "idle" || status === "sending";
          ...
          <form className={"contact-form" + (shake ? " shake" : "")} onSubmit={onSubmit}>
            {sendingOrIdle ? (
              <>
                ...
                {/* Honeypot: invisible para humanos, fuera del tab order. Si un bot lo
                    completa, /api/contact descarta el envío en silencio. */}
