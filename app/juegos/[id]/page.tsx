// ===== app/juegos/[id]/page.tsx =====
// Portado de references/templates/detalle.jsx (GameDetail). No requiere
// estado de cliente, por lo que queda como Server Component; notFound()
// reemplaza el `return null` del prototipo para ids inexistentes.
